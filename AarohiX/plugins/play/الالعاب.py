...
async def callback_query(client, CallbackQuery):
          if CallbackQuery.data == "GAME1":
             ...
             GAME1_MESSAGE = "ᯓ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚅𝙰𝚃𝙰𝚁𓃠\n\nمرحبا بك في قسم العاب 3D\n\nᯓ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚅𝙰𝚃𝙰𝚁 𓃠"
        ...
        InlineKeyboardButton ('ᯓ 𝚂𝙾𝚞𝚁𝚂 𝙰𝙵𝚁𝙾𝚃𝙾𝙾 𓃠', url =f"https://t.me/source_av")              
                 ],[
                InlineKeyboardButton(
                        "◁", callback_data="close"),
               ],
